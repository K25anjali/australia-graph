export const LEGEND_ITEMS = [
    ...
    { name: 'High Ambition', color: '#99cdc2', style: 'line', category: 'Scenarios' },
    { name: 'Historical', color: '#000000', style: 'line', category: 'Scenarios' },
    { name: 'NDC Target', color: '#9370db', style: 'triangle', category: 'Targets' },
    { name: 'Net-Zero Year', color: '#ff0000', style: 'triangle', category: 'Targets' },
    { name: 'Upper Uncertainty', color: '#4682b4', style: 'area', category: 'Uncertainty Range' },
    { name: 'Lower Uncertainty', color: '#4682b4', style: 'area', category: 'Uncertainty Range' },
